  ...
  return (
    <div className='home-links flex flex-wrap items-center justify-around max-w-4xl mt-6 sm:w-full'>
      ...
      <a
        ...
        className='border border-gray-100 dark:border-slate-800 hover:drop-shadow-sm group dark:text-white shadow-2xl max-w-xs p-6 mt-6 text-left md:w-96 rounded-xl hover:border-gray-500 transition ease-in-out delay-75 hover:-translate-y-1 hover:scale-105 hover:bg-blue-300 duration-300'
      >
        <h3 className='group-hover:text-black text-black dark:text-white text-lg sm:text-2xl font-bold'>
          <div className='flex flex-row items-center justify-start'>
